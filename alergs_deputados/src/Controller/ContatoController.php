...
class ContatoController extends ControllerBase {
  public function content($id = NULL) {
    ...
    if($token) {
      ...
      if($id) {
        curl_setopt_array($curl, array(
          CURLOPT_URL => \Drupal::config('alergs_import.settings')->get('alergs_import_url').'/alergsws/rest/agenciadenoticia/listarNoticiasDeputados/json/',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    return [
      '#theme' => 'alergs_deputados_contato',
